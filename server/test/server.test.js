...
describe("DELETE /todos/:id", function() {
  it("should remove a todo", done => {
    ...
    request(app)
      ...
      .end((err, res) => {
        ...
        // query database using findById to toNotExist
  ...
  it("should not remove a todo not owner", done => {
    var hexId = todos[0]._id.toHexString()
  ...
  it("should return 404 when if todo not found", done => {
    var hexId = new ObjectID().toHexString()
...
describe("PATH /todos/:id", () => {
  ...
  it("should not update the todo when not owner", done => {
    var hexId = todos[0]._id.toHexString()
    var text = "This should be a new text"
